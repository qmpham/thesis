...
\end{figure}
In our experiments with \system{CDR}, we consider only the Transformer architecture of \citet{Vaswani17attention} and the same experimental setting as in Section ~\ref{ssec:corpora-chap4}.
...
The description of MDMT systems for the comparison with \system{CDR} and \system{LDR} was provided in Section ~\ref{ssec:baselines-chap4}.
