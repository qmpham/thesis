...
\newcommand{\jurynameB}{Sennrich RICO}
\newcommand{\juryadressB}{Professor, University of Zurich}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Alexander M. FRASER}
\newcommand{\juryadressC}{Professor, Ludwig Maximilian University of Munich}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Marine CARPUAT}
\newcommand{\juryadressD}{Assistant professor, University of Maryland}
\newcommand{\juryroleD}{Examinatrice}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameG}{Pierre ZWEIGENBAUM}
\newcommand{\juryadressG}{Directeur de recherche, LISN$/$CNRS}
\newcommand{\juryroleG}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{François YVON}
\newcommand{\juryadressE}{Directeur de recherche, LISN$/$CNRS}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Josep Maria CREGO}
\newcommand{\juryadressF}{Head of research, Systran}
